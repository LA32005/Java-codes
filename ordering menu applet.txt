    ...
    public void init() {
     ...
     public void actionPerformed(ActionEvent ae){
           ...
           quantity =  Integer.parseInt(quan.getText());
            ...
            }else if (ae.getSource() == b37){
                totalAmount += quantity*graham;
            }else if (ae.getSource() == b38){
                totalAmount += quantity*halohalosmall;
            }else if (ae.getSource() == b39){
                totalAmount += quantity*halohalobig;
            }else if (ae.getSource() == b40){
            ...
            }else if (ae.getSource() == b43){
                totalAmount += quantity*cupcake;
            }else if (ae.getSource() == b44){
                totalAmount += quantity*cupcake;
            }else if (ae.getSource() == b45){
                totalAmount += quantity*cupcake;
            }else if (ae.getSource() == b46){
                totalAmount += quantity*twentyfive;
            }else if (ae.getSource() == b47){
                totalAmount += quantity*nachosbig;
            }
            else if (ae.getSource() == b48){
                totalAmount += quantity*twentyfive;
            }  
